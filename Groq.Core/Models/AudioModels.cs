...
public static class AudioModels
{
    ...
    ///     <para>
    ///         <b>Use Cases:</b> Real-time applications (live streaming, broadcast captioning), high-volume batch
    ///         processing, cost-effective solutions
    ///     </para>
    ///     <para>
    ///         <b>Best Practices:</b> Ideal for fast transcription requirements, real-time processing, and budget-conscious
    ///         applications
    ///     </para>
    /// </remarks>
    public static readonly Model WHISPER_LARGE_V3_TURBO = new()
    {
    ...
    /// <remarks>
    ///     <para>
    ///         <b>Model Architecture:</b> Transformer-based encoder-decoder with 1550M parameters and sophisticated
    ///         attention mechanism.
    ///     </para>
    ...
    ///     <para>
    ///         <b>Performance Metrics:</b> Short-form: 8.4% WER, Sequential long-form: 10.0% WER, Chunked long-form: 11.0%
    ///         WER
    ///     </para>
    ///     <para>
    ///         <b>Use Cases:</b> High-accuracy transcription (legal, medical), multilingual applications, challenging audio
    ///         conditions (noise, overlapping speech)
    ///     </para>
    ///     <para>
    ///         <b>Best Practices:</b> Prioritize accuracy over speed; leverage extensive language support; excellent for
    ///         difficult audio scenarios
    ///     </para>
    /// </remarks>
    public static readonly Model WHISPER_LARGE_V3 = new()
    {
        Id = "whisper-large-v3",
        Object = "model",
        Created = 1693721698,
    ...
    /// <remarks>
    ///     <para>
    ///         <b>Model Architecture:</b> Transformer architecture optimized for high-quality speech output with voice
    ...
    ///     <para>
    ///         <b>Training Data:</b> Millions of audio samples from diverse sources including video, audio works, and
    ///         interactive dialogue datasets
    ///     </para>
    ///     <para>
    ///         <b>Use Cases:</b> Creative content generation, voice agentic experiences, conversational AI, customer
    ///         support, accessibility tools
    ///     </para>
    ///     <para>
    ///         <b>Best Practices:</b> Use voice cloning and parameter customization; consider cultural sensitivity; keep
    ///         input under 10K characters; comply with Play.ht Terms of Service
    ///     </para>
    ///     <para>
    ///         <b>Limitations:</b> May reflect cultural biases in pronunciations and accents; outputs can be unpredictable
    ///         requiring human curation
    ///     </para>
    ///     <para><b>License:</b> PlayAI-Groq Commercial License</para>
    /// </remarks>
    public static readonly Model PLAYAI_TTS = new()
    {
        Id = "playai-tts",
        Object = "model",
        Created = 1740682771,
    ...
    ///     </para>
    ///     <para>
    ///         <b>Use Cases:</b> Arabic creative content generation, voice agentic experiences, conversational AI, customer
    ///         support for Arabic speakers, accessibility tools
    ///     </para>
    ///     <para>
    ///         <b>Best Practices:</b> Use voice cloning and parameter customization; consider cultural sensitivity for
    ///         Arabic contexts; keep input under 10K characters; comply with Play.ht Terms of Service
    ///     </para>
    ///     <para>
    ///         <b>Limitations:</b> May reflect cultural biases in pronunciations and accents; outputs can be unpredictable
    ///         requiring human curation
    ...
    ///     <para><b>License:</b> PlayAI-Groq Commercial License</para>
    /// </remarks>
    public static readonly Model PLAYAI_TTS_ARABIC = new()
    {
