...
public static class AgentModels
{
    ...
    /// <para><b>Capabilities:</b> Web Search, Code Execution (E2B), Visit Website, Browser Automation, Wolfram Alpha, JSON Object Mode</para>
    /// <para><b>Use Cases:</b> Realtime web search, code execution and generation, technical tasks with high-quality multilingual support</para>
    /// <para><b>Pricing:</b> Variable based on underlying models (GPT-OSS-120B: $0.15/$0.60 per 1M tokens, Llama 3.3 70B: $0.59/$0.79 per 1M tokens) and tool usage</para>
    /// <para><b>Best Practices:</b> Use system prompts for improved steerability; implement Llama Guard for content filtering; not for HIPAA protected health information</para>
    /// </remarks>
    ...
    /// This model provides unified tool integration and orchestration for real-time data access and environment interaction.
    /// </summary>
    /// <remarks>
    ...
    /// <para><b>Capabilities:</b> Web Search, Code Execution (E2B), Visit Website, Browser Automation, Wolfram Alpha, JSON Object Mode</para>
    /// <para><b>Use Cases:</b> Realtime web search, code execution and generation, technical tasks with high-quality multilingual support</para>
    /// <para><b>Pricing:</b> Variable based on underlying models (GPT-OSS-120B: $0.15/$0.60 per 1M tokens, Llama 4 Scout: $0.11/$0.34 per 1M tokens) and tool usage</para>
    /// <para><b>Performance:</b> Outperforms GPT-4o-search-preview and GPT-4o-mini-search-preview on RealtimeEval benchmark</para>
    /// <para><b>Best Practices:</b> Use system prompts for improved steerability; implement Llama Guard for content filtering; not for HIPAA protected health information</para>
    /// </remarks>
