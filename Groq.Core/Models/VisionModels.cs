...
public static class VisionModels
{
    ...
    /// </summary>
    /// <remarks>
    /// <para><b>Model Architecture:</b> Auto-regressive MoE with 17B activated parameters (109B total), 16 experts with early fusion for native multimodality.</para>
    ...
    /// <para><b>Languages:</b> 12 languages (Arabic, English, French, German, Hindi, Indonesian, Italian, Portuguese, Spanish, Tagalog, Thai, Vietnamese)</para>
    /// <para><b>Use Cases:</b> Multimodal assistant applications (visual recognition, image reasoning, captioning), code generation & technical tasks, long-context applications</para>
    /// <para><b>Best Practices:</b> Use system prompts for improved steerability; implement Llama Guard for safety; supports up to 5 image inputs; deploy with appropriate safeguards</para>
    ...
    /// </summary>
    /// <remarks>
    /// <para><b>Model Architecture:</b> Auto-regressive MoE with 17B activated parameters (400B total), 128 experts with early fusion for native multimodality.</para>
    /// <para><b>Context Window:</b> 131,072 tokens</para>
    /// <para><b>Max Output Tokens:</b> 8,192 tokens</para>
