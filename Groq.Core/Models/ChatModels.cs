...
public static class ChatModels
{
    ...
    /// </summary>
    /// <remarks>
    /// <para><b>Model Architecture:</b> MoE with 120B total parameters (5.1B active per forward pass), 36 layers, 128 experts, Top-4 routing.</para>
    ...
    /// <para><b>Use Cases:</b> Frontier-grade agentic applications, advanced research & scientific computing, high-accuracy math/coding, multilingual AI assistants</para>
    /// <para><b>Best Practices:</b> Use variable reasoning modes (low/medium/high); leverage Harmony chat format; utilize full 131K context window</para>
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// <para><b>Model Architecture:</b> MoE with 20B total parameters (3.6B active per forward pass), 24 layers, 32 experts, Top-4 routing.</para>
    /// <para><b>Context Window:</b> 131,072 tokens</para>
    /// <para><b>Max Output Tokens:</b> 65,536 tokens</para>
    ...
    /// <para><b>Use Cases:</b> Low-latency agentic applications, affordable reasoning & coding, tool-augmented applications, long-context processing</para>
    /// <para><b>Best Practices:</b> Use variable reasoning modes; provide clear tool definitions; structure complex tasks into steps; leverage multilingual capabilities</para>
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// <para><b>Model Architecture:</b> Based on Microsoft's mDeBERTa-base (86M parameters) with adversarial-attack resistant tokenization.</para>
    ...
    /// <para><b>Performance:</b> 99.8% AUC English jailbreak detection, 97.5% recall at 1% FPR, 81.2% attack prevention rate</para>
    /// <para><b>Use Cases:</b> Prompt attack detection (injections, jailbreaks), LLM pipeline security, multilingual content filtering</para>
    /// <para><b>Best Practices:</b> Split long inputs into segments; use 86M version for multilingual support; implement as part of multi-layered security</para>
    ...
    /// <para><b>Use Cases:</b> Complex problem solving (multi-step reasoning, math, coding), natural dialogue & content creation, multilingual content</para>
    /// <para><b>Best Practices:</b> Use thinking mode with reasoning_effort="default" for complex tasks; non-thinking mode for general dialogue; supports 100+ languages</para>
    ...
    /// </summary>
    /// <remarks>
    /// <para><b>Model Architecture:</b> 8 billion parameters with Grouped-Query Attention (GQA) for improved inference scalability.</para>
    /// <para><b>Context Window:</b> 131,072 tokens</para>
    ...
    /// <para><b>Use Cases:</b> Real-time applications (content moderation, interactive education, dynamic content generation), high-volume processing</para>
    /// <para><b>Best Practices:</b> Leverage large context window; simplify complex queries; enable JSON mode for structured data; include examples</para>
    ...
    /// </summary>
    /// <remarks>
    /// <para><b>Model Architecture:</b> Based on Llama 4 Scout architecture with 12 billion parameters, fine-tuned for content safety.</para>
    /// <para><b>Context Window:</b> 131,072 tokens</para>
    ...
    /// <para><b>Use Cases:</b> Content moderation (chatbots, forums, platforms), AI safety (prompt screening, output filtering), automated content screening</para>
    /// <para><b>Best Practices:</b> Configure safety thresholds appropriately; provide sufficient context; test with up to 5 input images</para>
    ...
    /// </summary>
    /// <remarks>
    /// <para><b>Model Architecture:</b> Based on Microsoft's DeBERTa-xsmall (22M parameters) with adversarial-attack resistant tokenization.</para>
    /// <para><b>Context Window:</b> 512 tokens</para>
    /// <para><b>Max Output Tokens:</b> 512 tokens</para>
    /// <para><b>Pricing:</b> Input/Output $0.03/1M tokens each</para>
    /// <para><b>Capabilities:</b> Content Moderation</para>
    /// <para><b>Performance:</b> 99.5% AUC English jailbreak detection, 88.7% recall at 1% FPR, 78.4% attack prevention rate, 75% latency reduction</para>
    /// <para><b>Use Cases:</b> Prompt attack detection (injections, jailbreaks), LLM pipeline security, real-time input analysis</para>
    /// <para><b>Best Practices:</b> Split long inputs into segments; use 22M version for better latency/efficiency; implement multi-layered security</para>
    ...
    /// </summary>
    /// <remarks>
    /// <para><b>Model Architecture:</b> MoE with 1 trillion total parameters (32B activated), 384 experts with 8 experts selected per token.</para>
    ...
    /// <para><b>Use Cases:</b> Enhanced frontend development (React, Vue, Angular), advanced agent scaffolds, tool calling excellence, full-stack development</para>
    /// <para><b>Best Practices:</b> Specify frameworks clearly; leverage improved scaffold integration; provide comprehensive tool schemas; use full 256K context</para>
    ...
    /// </summary>
    /// <remarks>
    /// <para><b>Model Architecture:</b> 70 billion parameters with Grouped-Query Attention (GQA) for enhanced inference scalability.</para>
    /// <para><b>Context Window:</b> 131,072 tokens</para>
    ...
    /// <para><b>Use Cases:</b> Advanced language understanding, code generation & problem solving, multilingual applications</para>
    /// <para><b>Best Practices:</b> Clearly specify task instructions; provide sufficient context; define tool/function definitions clearly</para>
