...
public sealed class GroqClient
{
    ...
    public GroqClient(GroqOptions options)
    {
        ...
        var httpClient = new HttpClient
        {
            ...
            DefaultRequestHeaders = { Authorization = new AuthenticationHeaderValue("Bearer", options.ApiKey) }
        };
    ...
    /// </summary>
    /// <value>
    ///     An <see cref="LlmTextProvider" /> instance providing a simplified client for text generation.
    /// </value>
    public LlmTextProvider LlmTextProvider { get; }
}
